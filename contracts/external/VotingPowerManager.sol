...
contract StakeContract {
  ...
  constructor(address _votingPower, uint _precision, address[] memory _governanceTokens, uint256[] memory coefficients) {
  ...
  function stake(address _governanceToken, uint _amount) public {
    ...
    uint amountOfVotingPower = _amount * multiplier / precision;
